    ...
    <div class="blog-menu-section">
        ...
        <div class="blog-row">
            ...
            <p>Pad kaphrao, as well as pad thai, were one of the promoted dishes in local Thai food contests.
                ...
                Some of the first four survivors of the Tham Luang cave rescue asked for phat kaphrao as their first
                proper meal after two weeks of being trapped inside the cave.</p>
            <br>
            <p>Pad kaphrao consists of meat such as pork, chicken, beef, and seafood stir fried with Thai holy
                basil and garlic. It is served with rice and topped up (optional) with fried eggs or khai dao. The main
                seasonings are soy sauce, Thai fish sauce, oyster sauce (optional), cane sugar, and bird's eye chili.
            </p>
        </div>
        <div class="blog-row">
            ...
            <p>Consumed typically with jasmine rice, Kana Moo Krob is Chinese broccoli that is stir-fried over high heat
                and tossed with garlic, chili, and crunchy pork belly, topped with soybean sauce and oyster sauce to
                give it a sweet and salty taste.
            </p><br>
            <p>Kana Moo Krob is a classic Thai comfort food, offering a delightful contrast between the tender-crisp
                Chinese broccoli and the irresistible crunch of pork belly crackling. This dish not only captivates your
                senses with its vibrant and appetizing appearance but also takes your palate on a journey through the
                heart of Thai flavors. Whether you're a Thai food enthusiast or a newcomer to this exciting cuisine,
                preparing Kana Moo Krob will bring the aromas and tastes of Thailand right to your kitchen. Get ready to
                discover the secrets of achieving that perfect crispy pork belly while creating a dish that's sure to
...
<section style="background-image: url(common/images/body-bg2.png);" id="about">
    <div class="video-section">
        ...
        <iframe style="border-radius: 10px" width="560" height="335" src="https://www.youtube.com/embed/LZvmfBJoYJM"
...
include("./common/head.php");
?>
<link rel="stylesheet" href="common/styles/indexdts.css">
